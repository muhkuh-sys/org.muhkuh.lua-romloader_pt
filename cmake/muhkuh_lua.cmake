...
#	LIST(APPEND CMAKE_PREFIX_PATH ${CMAKE_BINARY_DIR}/build_requirements/jonchki/install/dev/lib/cmake)
	...
	ELSEIF((${BUILDCFG_LUA_VERSION} STREQUAL "5.4"))
		SET(lua5.4_DIR ${CMAKE_BINARY_DIR}/build_requirements/jonchki/install/dev/lib/cmake/org.lua.lua)
		FIND_PACKAGE(lua5.4 CONFIG REQUIRED)
		SET(LUA_FOUND 1)
		GET_TARGET_PROPERTY(LUA_LIBRARIES org.lua.lua::lua5.4 LOCATION)
